...
public:
    ...
    void            setExitLock( int direction, bool locked );
    void            setSpecialExitLock( int to, QString cmd, bool locked );
    bool            hasExitLock( int direction );
    bool            hasSpecialExitLock( int to, QString cmd );
    ...
    bool            hasSpecialExit( QString cmd );
    bool            removeSpecialExit( QString cmd );
    bool            hasExitWeight( QString cmd );
    void            setSpecialExitLock( QString cmd, bool locked );
    ...
    QString         name;
    QVector3D       v;
    QList<int>      exitStubs; //contains a list of: exittype (according to
...
private:
    ...
    QMultiMap<int, QString> & __getOtherMap() { return other; }
};
