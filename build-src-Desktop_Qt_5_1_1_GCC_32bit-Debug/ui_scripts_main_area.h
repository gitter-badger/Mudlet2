...
public:
    ...
    void setupUi(QWidget *scripts_main_area)
    {
        if (scripts_main_area->objectName().isEmpty())
            scripts_main_area->setObjectName(QStringLiteral("scripts_main_area"));
        ...
        lineEdit_scripts_name->setObjectName(QStringLiteral("lineEdit_scripts_name"));
        ...
        listWidget_registered_event_handlers->setObjectName(QStringLiteral("listWidget_registered_event_handlers"));
    ...
    {
        scripts_main_area->setWindowTitle(QApplication::translate("scripts_main_area", "Form", 0));
        label_6->setText(QApplication::translate("scripts_main_area", "Script name:", 0));
        label->setText(QApplication::translate("scripts_main_area", "Registered Event Handlers:", 0));
        label_2->setText(QApplication::translate("scripts_main_area", "Add User Defined Event Handler:", 0));
#ifndef QT_NO_TOOLTIP
        toolButton_add->setToolTip(QApplication::translate("scripts_main_area", "add event handler to list", 0));
#endif // QT_NO_TOOLTIP
        toolButton_add->setText(QApplication::translate("scripts_main_area", "+", 0));
#ifndef QT_NO_TOOLTIP
        toolButton_remove->setToolTip(QApplication::translate("scripts_main_area", "remove event handler from list", 0));
#endif // QT_NO_TOOLTIP
        toolButton_remove->setText(QApplication::translate("scripts_main_area", "-", 0));
    } // retranslateUi
