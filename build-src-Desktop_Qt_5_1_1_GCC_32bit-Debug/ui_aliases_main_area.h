...
public:
    ...
    void setupUi(QWidget *aliases_main_area)
    {
        if (aliases_main_area->objectName().isEmpty())
            aliases_main_area->setObjectName(QStringLiteral("aliases_main_area"));
        ...
        lineEdit_alias_name->setObjectName(QStringLiteral("lineEdit_alias_name"));
        ...
        pattern_textedit->setObjectName(QStringLiteral("pattern_textedit"));
        ...
        substitution->setObjectName(QStringLiteral("substitution"));
    ...
    {
        aliases_main_area->setWindowTitle(QApplication::translate("aliases_main_area", "Form", 0));
        label_2->setText(QApplication::translate("aliases_main_area", "Alias name:", 0));
#ifndef QT_NO_TOOLTIP
        lineEdit_alias_name->setToolTip(QApplication::translate("aliases_main_area", "chose a unique name for your alias; it will show in the tree and is needed for scripting.", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("aliases_main_area", "Pattern:", 0));
#ifndef QT_NO_TOOLTIP
        pattern_textedit->setToolTip(QApplication::translate("aliases_main_area", "enter a perl regex pattern for your alias; alias are triggers on your input", 0));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("aliases_main_area", "Type:", 0));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("aliases_main_area", "Regex", 0)
         << QApplication::translate("aliases_main_area", "Plain", 0)
        );
        label_3->setText(QApplication::translate("aliases_main_area", "Substitution:", 0));
#ifndef QT_NO_TOOLTIP
        substitution->setToolTip(QApplication::translate("aliases_main_area", "optional, simple text substitution that is sent to the MUD if the alias pattern matches your input", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
