...
struct qt_meta_stringdata_TEasyButtonBar_t {
    QByteArrayData data[3];
    char stringdata[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TEasyButtonBar_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TEasyButtonBar_t qt_meta_stringdata_TEasyButtonBar = {
    {
QT_MOC_LITERAL(0, 0, 14),
QT_MOC_LITERAL(1, 15, 12),
QT_MOC_LITERAL(2, 28, 0)
    },
    "TEasyButtonBar\0slot_pressed\0\0"
};
...
const QMetaObject TEasyButtonBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TEasyButtonBar.data,
      qt_meta_data_TEasyButtonBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TEasyButtonBar.stringdata))
