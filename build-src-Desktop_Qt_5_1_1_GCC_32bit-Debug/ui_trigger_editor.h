...
public:
    ...
    TTreeWidget *treeWidget_vars;
    TTreeWidget *treeWidget;
    QPushButton *toggleHiddenVarsButton;
    ...
    void setupUi(QMainWindow *trigger_editor)
    {
        if (trigger_editor->objectName().isEmpty())
            trigger_editor->setObjectName(QStringLiteral("trigger_editor"));
        ...
        randomwidget->setObjectName(QStringLiteral("randomwidget"));
        ...
        treeWidget_timers->setObjectName(QStringLiteral("treeWidget_timers"));
        ...
        treeWidget_timers->setAnimated(true);
        ...
        treeWidget_keys->setObjectName(QStringLiteral("treeWidget_keys"));
        ...
        treeWidget_alias->setObjectName(QStringLiteral("treeWidget_alias"));
        ...
        treeWidget_actions->setObjectName(QStringLiteral("treeWidget_actions"));
        ...
        treeWidget_scripts->setObjectName(QStringLiteral("treeWidget_scripts"));
        ...
        treeWidget_vars = new TTreeWidget(left_frame);
        treeWidget_vars->setObjectName(QStringLiteral("treeWidget_vars"));
        treeWidget_vars->setFrameShape(QFrame::NoFrame);
        treeWidget_vars->setMidLineWidth(4);
        treeWidget_vars->setDragDropMode(QAbstractItemView::InternalMove);
        treeWidget_vars->setAlternatingRowColors(false);
        treeWidget_vars->setIconSize(QSize(32, 32));
        treeWidget_vars->setRootIsDecorated(true);
        treeWidget_vars->setAnimated(true);
        treeWidget_vars->setAllColumnsShowFocus(true);
        treeWidget_vars->setWordWrap(false);
        treeWidget_vars->setHeaderHidden(false);
        treeWidget_vars->setExpandsOnDoubleClick(false);

        verticalLayout_3->addWidget(treeWidget_vars);
        ...
        toggleHiddenVarsButton = new QPushButton(left_frame);
        toggleHiddenVarsButton->setObjectName(QStringLiteral("toggleHiddenVarsButton"));
        toggleHiddenVarsButton->setCheckable(true);
        toggleHiddenVarsButton->setAutoDefault(false);
        toggleHiddenVarsButton->setDefault(false);
        toggleHiddenVarsButton->setFlat(false);

        verticalLayout_3->addWidget(toggleHiddenVarsButton);

        mpSearchArea = new QWidget(left_frame);
        mpSearchArea->setObjectName(QStringLiteral("mpSearchArea"));
        ...
        comboBox_search_triggers->setObjectName(QStringLiteral("comboBox_search_triggers"));
        ...
        messageAreaCloseButton->setObjectName(QStringLiteral("messageAreaCloseButton"));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/application-exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tree_widget_search_results_main->setObjectName(QStringLiteral("tree_widget_search_results_main"));
        ...
        popupArea->setObjectName(QStringLiteral("popupArea"));
    ...
    {
        trigger_editor->setWindowTitle(QApplication::translate("trigger_editor", "Script editor", 0));
        actionAlias->setText(QApplication::translate("trigger_editor", "Alias", 0));
        toolButton_add_trigger_menu->setText(QApplication::translate("trigger_editor", "Trigger", 0));
        actionVariable->setText(QApplication::translate("trigger_editor", "Variable", 0));
        actionAlias_2->setText(QApplication::translate("trigger_editor", "Alias", 0));
        toolButton_delete_trigger_menu->setText(QApplication::translate("trigger_editor", "Trigger", 0));
        actionVariable_2->setText(QApplication::translate("trigger_editor", "Variable", 0));
        toolButton_add_trigger_group_menu->setText(QApplication::translate("trigger_editor", "Group", 0));
        actionGroup->setText(QApplication::translate("trigger_editor", "Group", 0));
        actionAliases->setText(QApplication::translate("trigger_editor", "Aliases", 0));
        actionTriggers->setText(QApplication::translate("trigger_editor", "Triggers", 0));
        actionVariables->setText(QApplication::translate("trigger_editor", "Variables", 0));
        actionScript_options->setText(QApplication::translate("trigger_editor", "Script options", 0));
        toolButton_search_area_2_menu->setText(QApplication::translate("trigger_editor", "Search results", 0));
        actionExpert_mode_menu->setText(QApplication::translate("trigger_editor", "Expert mode", 0));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget_timers->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("trigger_editor", "1", 0));
        QTreeWidgetItem *___qtreewidgetitem1 = treeWidget_keys->headerItem();
        ___qtreewidgetitem1->setText(0, QApplication::translate("trigger_editor", "1", 0));
        QTreeWidgetItem *___qtreewidgetitem2 = treeWidget_alias->headerItem();
        ___qtreewidgetitem2->setText(0, QApplication::translate("trigger_editor", "1", 0));
        QTreeWidgetItem *___qtreewidgetitem3 = treeWidget_actions->headerItem();
        ___qtreewidgetitem3->setText(0, QApplication::translate("trigger_editor", "1", 0));
        QTreeWidgetItem *___qtreewidgetitem4 = treeWidget_scripts->headerItem();
        ___qtreewidgetitem4->setText(0, QApplication::translate("trigger_editor", "1", 0));
        QTreeWidgetItem *___qtreewidgetitem5 = treeWidget_vars->headerItem();
        ___qtreewidgetitem5->setText(0, QApplication::translate("trigger_editor", "1", 0));
        QTreeWidgetItem *___qtreewidgetitem6 = treeWidget->headerItem();
        ___qtreewidgetitem6->setText(0, QApplication::translate("trigger_editor", "1", 0));
        toggleHiddenVarsButton->setText(QApplication::translate("trigger_editor", "Toggle Hidden Variables", 0));
        label->setText(QApplication::translate("trigger_editor", "Search:", 0));
        messageAreaCloseButton->setText(QApplication::translate("trigger_editor", "...", 0));
        QTreeWidgetItem *___qtreewidgetitem7 = tree_widget_search_results_main->headerItem();
        ___qtreewidgetitem7->setText(0, QApplication::translate("trigger_editor", "1", 0));
    } // retranslateUi
