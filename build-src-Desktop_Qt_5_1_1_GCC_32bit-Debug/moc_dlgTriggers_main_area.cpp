...
#include "../src/dlgTriggers_main_area.h"
...
struct qt_meta_stringdata_dlgTriggersMainArea_t {
    QByteArrayData data[1];
    char stringdata[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_dlgTriggersMainArea_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_dlgTriggersMainArea_t qt_meta_stringdata_dlgTriggersMainArea = {
    {
...
const QMetaObject dlgTriggersMainArea::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_dlgTriggersMainArea.data,
      qt_meta_data_dlgTriggersMainArea,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_dlgTriggersMainArea.stringdata))
