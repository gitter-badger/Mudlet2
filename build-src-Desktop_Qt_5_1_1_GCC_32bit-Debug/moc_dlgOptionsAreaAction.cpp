...
#include "../src/dlgOptionsAreaAction.h"
...
struct qt_meta_stringdata_dlgOptionsAreaAction_t {
    QByteArrayData data[1];
    char stringdata[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_dlgOptionsAreaAction_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_dlgOptionsAreaAction_t qt_meta_stringdata_dlgOptionsAreaAction = {
    {
...
void dlgOptionsAreaAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject dlgOptionsAreaAction::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_dlgOptionsAreaAction.data,
      qt_meta_data_dlgOptionsAreaAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_dlgOptionsAreaAction.stringdata))
