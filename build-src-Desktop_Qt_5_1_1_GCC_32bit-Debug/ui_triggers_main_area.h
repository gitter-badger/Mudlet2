...
public:
    ...
    void setupUi(QWidget *trigger_main_area)
    {
        if (trigger_main_area->objectName().isEmpty())
            trigger_main_area->setObjectName(QStringLiteral("trigger_main_area"));
        ...
        lineEdit_trigger_name->setObjectName(QStringLiteral("lineEdit_trigger_name"));
        ...
        trigger_command->setObjectName(QStringLiteral("trigger_command"));
        ...
        patternArea->setObjectName(QStringLiteral("patternArea"));
        ...
        checkBox_stayOpen->setObjectName(QStringLiteral("checkBox_stayOpen"));
        ...
        spinBox_stayOpen->setObjectName(QStringLiteral("spinBox_stayOpen"));
        ...
        soundTrigger->setObjectName(QStringLiteral("soundTrigger"));
        ...
        lineEdit_soundFile->setObjectName(QStringLiteral("lineEdit_soundFile"));
        ...
        checkBox_multlinetrigger->setObjectName(QStringLiteral("checkBox_multlinetrigger"));
        ...
        spinBox_linemargin->setObjectName(QStringLiteral("spinBox_linemargin"));
        ...
        filterTrigger->setObjectName(QStringLiteral("filterTrigger"));
        ...
        perlSlashGOption->setObjectName(QStringLiteral("perlSlashGOption"));
        ...
        colorizerTrigger->setObjectName(QStringLiteral("colorizerTrigger"));
        ...
        pushButtonFgColor->setObjectName(QStringLiteral("pushButtonFgColor"));
        ...
        pushButtonBgColor->setObjectName(QStringLiteral("pushButtonBgColor"));
    ...
    {
        trigger_main_area->setWindowTitle(QApplication::translate("trigger_main_area", "Form", 0));
        label_4->setText(QApplication::translate("trigger_main_area", "name:", 0));
#ifndef QT_NO_TOOLTIP
        lineEdit_trigger_name->setToolTip(QApplication::translate("trigger_main_area", "Chose a good name for your trigger. This name will be displayed in the trigger tree.", 0));
#endif // QT_NO_TOOLTIP
        label_5->setText(QApplication::translate("trigger_main_area", "send plain text:", 0));
#ifndef QT_NO_TOOLTIP
        trigger_command->setToolTip(QApplication::translate("trigger_main_area", "Type in what command you want the trigger to send to the MUD if it fires. (optional)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBox_stayOpen->setToolTip(QApplication::translate("trigger_main_area", "Keep firing the script for x more lines, after the trigger or chain has matched.", 0));
#endif // QT_NO_TOOLTIP
        checkBox_stayOpen->setTitle(QApplication::translate("trigger_main_area", "fire length", 0));
#ifndef QT_NO_TOOLTIP
        spinBox_stayOpen->setToolTip(QApplication::translate("trigger_main_area", "Within how many lines must all condition be true to fire the trigger?", 0));
#endif // QT_NO_TOOLTIP
        label_6->setText(QApplication::translate("trigger_main_area", "more lines", 0));
#ifndef QT_NO_TOOLTIP
        soundTrigger->setToolTip(QApplication::translate("trigger_main_area", "play a wave sound file if the trigger fires", 0));
#endif // QT_NO_TOOLTIP
        soundTrigger->setTitle(QApplication::translate("trigger_main_area", "play sound", 0));
        label_16->setText(QApplication::translate("trigger_main_area", "chose file:", 0));
...
"as this is a complex topic.", 0));
#endif // QT_NO_TOOLTIP
        checkBox_multlinetrigger->setTitle(QApplication::translate("trigger_main_area", "multiline / AND Trigger", 0));
        label_3->setText(QApplication::translate("trigger_main_area", "line delta", 0));
#ifndef QT_NO_TOOLTIP
        spinBox_linemargin->setToolTip(QApplication::translate("trigger_main_area", "Within how many lines must all condition be true to fire the trigger?", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        filterTrigger->setToolTip(QApplication::translate("trigger_main_area", "act as filter, i.e. only pass matches to its children to trigger on, instead of the original line from the MUD", 0));
#endif // QT_NO_TOOLTIP
        filterTrigger->setTitle(QApplication::translate("trigger_main_area", "filter", 0));
#ifndef QT_NO_TOOLTIP
        label_15->setToolTip(QApplication::translate("trigger_main_area", "Only the filtered content (=capture groups) will be passed on to child triggers, not the initial line (see manual on filters)", 0));
#endif // QT_NO_TOOLTIP
        label_15->setText(QApplication::translate("trigger_main_area", "only pass matches to children as trigger input", 0));
#ifndef QT_NO_TOOLTIP
...
"Without this option, the pattern matching will stop after the first successful match.", 0));
#endif // QT_NO_TOOLTIP
        perlSlashGOption->setTitle(QApplication::translate("trigger_main_area", "match all", 0));
#ifndef QT_NO_TOOLTIP
        label_17->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        label_17->setText(QApplication::translate("trigger_main_area", "match all occurences of the pattern in the line", 0));
#ifndef QT_NO_TOOLTIP
        colorizerTrigger->setToolTip(QApplication::translate("trigger_main_area", "highlight the capture groups if there are any\n"
"otherwise highlight the entire match", 0));
#endif // QT_NO_TOOLTIP
        colorizerTrigger->setTitle(QApplication::translate("trigger_main_area", "highlight", 0));
        pushButtonFgColor->setText(QString());
        label_9->setText(QApplication::translate("trigger_main_area", "fg color", 0));
        pushButtonBgColor->setText(QString());
        label_10->setText(QApplication::translate("trigger_main_area", "bg color", 0));
    } // retranslateUi
