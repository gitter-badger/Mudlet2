...
struct qt_meta_stringdata_TToolBar_t {
    QByteArrayData data[3];
    char stringdata[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TToolBar_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TToolBar_t qt_meta_stringdata_TToolBar = {
    {
QT_MOC_LITERAL(0, 0, 8),
QT_MOC_LITERAL(1, 9, 12),
QT_MOC_LITERAL(2, 22, 0)
    },
    "TToolBar\0slot_pressed\0\0"
};
...
const QMetaObject TToolBar::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_TToolBar.data,
      qt_meta_data_TToolBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TToolBar.stringdata))
