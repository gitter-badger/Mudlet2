...
struct qt_meta_stringdata_TForkedProcess_t {
    QByteArrayData data[4];
    char stringdata[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TForkedProcess_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TForkedProcess_t qt_meta_stringdata_TForkedProcess = {
    {
...
QT_MOC_LITERAL(3, 33, 10)
    ...
    "TForkedProcess\0slotReceivedData\0\0"
    "slotFinish\0"
};
...
const QMetaObject TForkedProcess::staticMetaObject = {
    { &QProcess::staticMetaObject, qt_meta_stringdata_TForkedProcess.data,
      qt_meta_data_TForkedProcess,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TForkedProcess.stringdata))
