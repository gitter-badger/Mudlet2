...
struct qt_meta_stringdata_EAction_t {
    QByteArrayData data[6];
    char stringdata[50];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_EAction_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_EAction_t qt_meta_stringdata_EAction = {
    {
...
QT_MOC_LITERAL(5, 41, 7)
    ...
    "EAction\0triggered\0\0QAction*\0slot_execute\0"
    "checked\0"
};
...
void EAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (EAction::*_t)(QAction * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EAction::triggered)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject EAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_EAction.data,
      qt_meta_data_EAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EAction.stringdata))
