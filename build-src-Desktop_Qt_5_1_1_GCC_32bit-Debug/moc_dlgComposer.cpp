...
struct qt_meta_stringdata_dlgComposer_t {
    QByteArrayData data[4];
    char stringdata[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_dlgComposer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_dlgComposer_t qt_meta_stringdata_dlgComposer = {
    {
...
void dlgComposer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        dlgComposer *_t = static_cast<dlgComposer *>(_o);
        switch (_id) {
...
const QMetaObject dlgComposer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_dlgComposer.data,
      qt_meta_data_dlgComposer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_dlgComposer.stringdata))
